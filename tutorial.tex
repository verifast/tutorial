...
{\small iMinds-DistriNet, Department of Computer Science, KU Leuven - University of Leuven, Belgium}}
...
its precondition and postcondition, not its body.
...
instance \lstinline|myAccount| allocated using $\mathit{malloc}$. However,
if there is insufficient memory, $\mathit{malloc}$ returns zero and no
