...
\texttt{illegal\_access.c} program that can be found on the
VeriFast homepage. The program will be shown in the VeriFast
IDE. To verify the program, choose the \textbf{Verify program}
command in the \textbf{Verify} menu, press the \textbf{Play}
toolbar button, or press F5. You will see something like
Fig~\ref{figure:illegal-access1}.
\begin{figure}
\begin{center}
...
Ctrl+F5. (See Fig.~\ref{figure:illegal-access2}.)
\begin{figure}
\begin{center}
\includegraphics[width=7cm]{illegal_access2.png}
\end{center}
\caption{The VeriFast IDE shows a symbolic execution path of function $\mathsf{main}$}\label{figure:illegal-access2}
\end{figure}
...
$\mathit{free}$ statement. Indeed, this statement is incorrect,
